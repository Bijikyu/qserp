 ...
 */
const REQUIRED_VARS = ['GOOGLE_API_KEY', 'GOOGLE_CX']; //minimal credentials needed for searches
 ...
 */
const OPTIONAL_VARS = ['OPENAI_TOKEN', 'GOOGLE_REFERER']; //additional features but not required
 ...
 */
const OPENAI_WARN_MSG = 'OPENAI_TOKEN environment variable is not set. This is required by the qerrors dependency for error logging.'; //central message reused by warnIfMissingEnvVars
